          ...
          <div className="flex flex-col bg-primary items-center justify-center p-6 ">
            ...
            <div className="items-center justify-center bg-white rounded-xl md:w-[700px] overflow-hidden">
              ...
              <Swiper
                ...
                slidesPerView={1} // Set to 1 for smaller screens
              ...
              >
                <SwiperSlide>
                  <div className="w-[382px] h-[488px] px-8 mb-3">
                    <div>
                      <div className="w-5 h-5 rounded-full"></div>
                      <h3 className='flex items-center'><span className='mr-4'> <IoIosBook /></span>Educational Resources</h3>
                    </div>
                    <div className="mt-2 bg-gray-300">
                      <img src={eduResources} alt='educational resources' className="w-full h-full " />
                    </div>
                    <div>
                      ...
                      <p>
                        Unlock a world of knowledge on child health and development.
                        Our curated educational resources guide you through every stage,
                        empowering you to make informed choices for your child's well-being.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="w-[382px] h-[488px] px-8 mb-3">
                    <div>
                      <div className="w-5 h-5 rounded-full"></div>
                      <h3 className='flex items-center'><span className='mr-4'> <MdOutlineMoreTime /></span>Real Time Consultations</h3>
                    </div>
                    <div className="mt-2 bg-gray-300">
                      <img src={realtimeConsult} alt='real time consultations' className="w-full h-full" />
                    </div>
                    <div>
                      <h4 className="font-bold text-md my-2">
                        Face to Face Care, Virtually
                      </h4>
                      <p>
                        Experience real-time video consultations with healthcare professionals from the comfort of your home.
                        Treasures brings the clinic to you, ensuring your child gets the care they need, when they need it.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide>
                  <div className="w-[382px] h-[488px] px-8 mb-3">
                    <div>
                      <div className="w-5 h-5 rounded-full"></div>
                      <h3 className='flex items-center'><span className='mr-4'><IoEyeOutline /></span>Virtual Appointments</h3>
                    </div>
                    <div className="mt-2 bg-gray-300">
                      <img src={virtualAppoint} alt='Virtual Appointments' />
                    </div>
                    <div>
                      <h4 className="font-bold text-md my-2">
                      ...
                      <p>
                        Say goodbye to long waiting times. With Treasures, book
                        virtual appointments with healthcare professionals
                        effortlessly. Your child's health, your schedule.
                      </p>
                    </div>
                  </div>
                </SwiperSlide>
