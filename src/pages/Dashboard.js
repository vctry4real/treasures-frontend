                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="relative">
                            ...
                            <div className={`absolute top-full right-0 mt-2 ${isOpen ? 'block' : 'hidden'} w-48 bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600`} role="menu" aria-orientation="vertical" aria-labelledby="dropdown-user">
                                <div className="px-4 py-3">
                                    <p className="text-sm text-gray-900 dark:text-white">{ProfileData.name}</p>
                                    <p className="text-sm font-medium text-gray-900 truncate dark:text-gray-300">{ProfileData.email}</p>
                                </div>
                                <ul className="py-1" role="none">
                                    <Link to="/dashboard" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"><li>Dashboard</li></Link>
                                    <Link to="" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"> <li>Profile</li></Link>
                                    <Link to="" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"><li>Savings</li></Link>
                                    <Link to="" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem"><li>Sign out</li></Link>
                                </ul>
                            </div>
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <Link to="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <li className="flex items-center p-2">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Premium Package</span>
                            </li>
                        </Link>
                        ...
                        <Link to="/dashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <li className="flex items-center p-2">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Help & Feedback</span>
                            </li>
                        </Link>
            ...
            <div className="p-4 sm:ml-64">
                <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                    ...
                    <div className="flex flex-col items-center gap-2 text-left p-2 h-auto mb-9 rounded-xl bg-primary">
                        ...
                        <h3 className='w-full flex items-center text-white text-left text-md font-bold'>Browse Health Professional <span className="pl-2 mr-2"><FaLongArrowAltRight /></span></h3>
                    </div>
                    <div className="flex flex-row gap-8 mb-6">
                        <div className="flex flex-col items-center justify-center rounded bg-transparent">
                            <div className="text-left w-full"> {/* Add text-left class here */}
                                <h3 className="text-xl text-gray-800 flex flex-grow items-center font-semibold">
                                    Welcome  <span className='ml-2'><PiHandWavingFill className='text-yellow-500' /></span>
                                </h3>
                                <p className='text-md text-gray-900'>You have an upcoming session</p>
                            </div>
                        </div>
                        <div className=''>
                            <button className='p-2 rounded-2xl border  ml-auto w-[120px] bg-slate-100'>See upcoming</button>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row gap-2 mb-4">
                        <div className="flex flex-col items-center justify-center rounded bg-transparent">
                            <div className="text-left"> {/* Add text-left class here */}
                                <h3 className="text-lg text-gray-800">
                                    Your children's profiles
                                </h3>
                                <p className='text-[13px] text-gray-900 '>You have no child profile, please tap the add button to add your child(ren)</p>
                            </div>
                        </div>
                        <div className=''>
                            <FaGreaterThan />
                        ...
                        <div className='flex flex-col items-start justify-start w-full '>
                            <Link to="/">
                                <div className='flex items-center justify-center bg-gray-200 w-[64px] h-[64px] rounded-full px-4 py-2 border-2 border-gray-900 shadow-sm '>
                                    <svg className="w-3.5 h-3.5 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="black" viewBox="0 0 18 18">
                    ...
                    <div className="flex items-center justify-center p-4 mb-7 rounded-2xl bg-gray-100">
                        <div>
                            <p className=" flex flex-row items-center text-2xl text-gray-400 dark:text-gray-500"> <span className='mr-3'><IoBookSharp /></span>Book Appointment</p>
                        </div>
                    </div>
                        ...
                        <SwiperSlide>
                            <div className="flex flex-col items-center justify-center rounded p-2 mb-7 bg-pink-50 h-28">
                                ...
                                <div className='w-full flex items-center gap-4'>
                                    ...
                                    <div className=''>
                                        <p className="text-md text-gray-400">You Have no schedules.</p>
                    ...
                    <div className="flex flex-col gap-5 items-center w-full justify-center h-auto mb-4 rounded">
                        <div className='flex w-full items-center'>
                            <h1 className='text-xl text-left font-bold'>Recent Consultations</h1>
                        ...
                        <div className='flex w-full flex-col gap-7'>
                            ...
                            <div className=" w-full flex flex-row items-center">
                                <div className=' flex items-center justify-start text-lef m'>
                                    <div className='w-[40px] h-[40px] mr-2 rounded-full border overflow:hidden'>
                                        <img src={LateefatOdubanjo} alt="/" className='w-[40px] h-[40px] rounded-full' />
                                    </div>
                                    <div>
                                        <p className='text-lg font-semibold'>Latifat Odubanjo</p>
                                        <p className='text-md font-medium' >Senior Physiotherapist</p>
                                    </div>
                                </div>
                                <button className="w-1/4 px-2 py-1 border border-gray-300 rounded-xl ml-auto ">Message</button>
                            </div>
                            ...
                            <div className=" w-full flex flex-row items-center">
                                <div className=' flex items-center justify-start text-lef m'>
                                    <div className='w-[40px] h-[40px] mr-2 rounded-full border overflow:hidden'>
                                        <img src={DevonLane} alt="/" className='w-[40px] h-[40px]' />
                                    </div>
                                    <div>
                            ...
                            <div className=" w-full flex flex-row items-center">
                                <div className=' flex items-center justify-start text-lef m'>
                                    <div className='w-[40px] h-[40px] mr-2 rounded-full border overflow:hidden'>
                                        <img src={CameronWilliams} alt="/" className='w-[40px] h-[40px]' />
                                    </div>
                                    <div>
                            ...
                            <div className=" w-full flex flex-row items-center">
                                <div className=' flex items-center justify-start text-lef m'>
                                    <div className='w-[40px] h-[40px] mr-2 rounded-full border overflow:hidden'>
                                        <img src={KathrynMurphy} alt="/" className='w-[40px] rounded-full h-[40px]' />
                                    </div>
                                    <div>
                                ...
                                <button className="w-1/4 px-1 py-1 border border-gray-300 rounded-xl ml-auto ">Message</button>
                            </div>
                        ...
                        <div className="flex flex-col items-center justify-center rounded p-3 my-7 bg-blue-200 h-auto">
                            <div className='w-full mb-3'>
                                ...
                                <h2 className='text-lg font-bold my-3'>How to prepare for your first meeting?</h2>
                            </div>
                            <div className='w-full flex items-center gap-4'>
                                <div>
                                    <p className="text-md text-gray-700">
                                        Plan an agenda! Plan out the questions and topics you’d like to discuss. If you’d like to work together on long-terms goals, set some time to discuss expectation for each other.
                                    </p>
                                </div>
