    ...
    <>
      ...
      <div className="w-full h-auto mt-[20px]  bg-white overflow-hidden ">
        ...
        <div className="flex flex-col items-center justify-center m-6">
          ...
          <button className="flex items-center justify-center text-gray-900 bg-transparent rounded-2xl w-[193px] h-[56px] m-10 py-2 px-4 text-md font-bold">
            Explore Features{' '}
            <span className="pl-2">
              <FaArrowRight />
            </span>
        ...
        <div className="flex flex-col bg-gray-950 items-center justify-center ">
          ...
          <button className="flex items-center justify-center text-white bg-transparent rounded-2xl w-[193px] h-[56px] m-10 py-2 px-4 text-md font-bold md:w-full md:h-[60px] md:items-center">
            Start your Journey{' '}
            <span className="pl-2">
              <FaArrowRight />
            </span>
        ...
        <div className="flex flex-col bg-black  items-center justify-center p-6 md:grid grid-cols-1  ">
          <div className=" items-center justify-center">
            ...
            <h3 className="font-medium text-lg text-white text-left pt-6">
              Have Questions? Our support teams are available 24/7
            </h3>
            <p className="font-light text-[18px] text-left pt-4 tracking-wide text-white">
              Need assistance, want to learn more? Or partner with us. Get in
              touch with Treasure today.
            </p>
            <button className="flex items-center justify-center text-white bg-transparent rounded-2xl w-[193px] h-[56px] m-10 py-2 px-4 text-md font-bold md:justify-start md:m-1 md:p-0">
              Explore Features{' '}
              <span className="pl-2">
                <FaArrowRight />
              </span>
          ...
          <div className=" items-center justify-center border-t">
            ...
            >
              ...
              <button className="w-full h-[40px] text-white bg-gray-700 text-center mt-4 md:w-[500px] md:px-5">
                Subscribe Now
              </button>
            </form>
