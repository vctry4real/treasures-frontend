    ...
    <>
      <div className="w-full h-auto  bg-white  overflow-hidden ">
        <div className="w-full h-auto ">
          ...
          <div className="flex flex-row gap-16 h-screen px-6 items-center justify-center  ">
            {/* background image */}
            ...
            <div className="flex flex-col bg-zinc-200 items-center justify-center ">
              ...
              <div className='flex flex-col items-center justify-center text-white relative'>
                ...
                <h2 className="w-full h-[80px] font-bold text-4xl text-center pt-8 mb-4 md:text-left ">
                  Your Child Wellness Companion
                </h2>
                <p className="w-full h-[120px] font-medium text-[18px] text-center my-16 md:text-center md:w-[460px] md:mt-10 ">
                ...
                <div className="mt-6 md:w-full flex flex-row justify-center ">
                  <button
          ...
          <div className='w-full h-auto '>
            <div className='flex space-x-16 py-4 relative'>
              <svg className="absolute top-[-8px] right-0 md:top-[-10px]" width="65" height="91" viewBox="0 0 65 91" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-white w-full flex flex-col items-center justify-center p-6">
              ...
              <div className="md:flex flex-row gap-9 mt-6 items-center justify-center w-full ">
                <div className="flex flex-col h-[329px] rounded-md bg-secondary-100 items-center justify-center p-5">
                  <div className="w-full h-auto bg-gray-500 text-center rounded-md text-black">
                    <img src={card1} alt='card1' className='h-auto w-full' />
                  </div>
                  <div className="w-full h-auto">
                    <h3 className="font-bold text-xl text-gray-900 text-left mb-2 pt-5 ">
                ...
                {/* Second card */}
                <div className="flex flex-col mt-6 h-[329px] rounded-md bg-secondary-100 items-center justify-center p-5 md:mt-0">
                  <div className="w-full h-auto bg-gray-500 text-center rounded-md text-black">
                    <img src={card2} alt='card1' className='h-auto w-full' />
                  </div>
                  <div className="w-full h-auto">
                    <h3 className="font-bold text-xl text-gray-900 text-left mb-2 pt-5 ">
                    ...
                    <p>
                      Unleash the full potential of your little ones with a holistic
                      approach to wellness, blending the best of healthcare, education, and support.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className=" w-full pt-1 bg-[#E5EEEE] p-6">
            <div className="flex flex-col items-center justify-center mt-[90px]">
              <h2 className="w-full h-auto font-bold text-4xl text-gray-900 text-center pt-1 mb-1 ">
                Join Treasures Today
              </h2>
              <h3 className=" w-full h-auto font-medium text-2xl text-gray-900 text-center pt-1 mb-3 md:w-[600px] md:h-auto ">
                Ready to start your child's wellnes Journey
              </h3>
              <p className="w-full h-auto font-medium text-[18px] text-center mt-4 md:w-[650px]">
          ...
          {/* Footer here */}
          <div className="w-full flex flex-col bg-primary  items-center justify-center p-6 md:grid grid-cols-1  ">
            <div className=" items-center justify-center">
            ...
            <div className="w-full items-center border-t">
              ...
              <ul className="w-full grid grid-cols-1 pt-8 md:grid-cols-3">
                <div className=" pb-6 ">
