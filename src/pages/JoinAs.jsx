...
const userCategories = [
  {
    ...
    isSelected: false,
    icon: (
      <svg class="bg-black rounded-md fill-gray-200" viewBox="-1 0 19 19">
  ...
  },
  {
    ...
    isSelected: true,
    icon: (
      <svg class="  bg-black rounded-md fill-gray-200" viewBox="-1.5 0 24 24">
  ...
  },
  {
    ...
    isSelected: false,
    icon: (
      <svg class="bg-black rounded-md fill-gray-200" viewBox="0 1 612 612">
        <path
...
const CardListItem = ({ cardType }) => {
  ...
  return (
    // <form>
    <div
      className="cursor-pointer hover:bg-gray-200 active:bg-gray-400 focus:bg-primary flex flex-col border-2 border-grey p-4 gap-4 mb-4 max-w-700 w-full shadow-3xl rounded-md bg-grey-800"
      // onClick={""}
    >
      <div className="flex justify-between item-center ">
        <div className="h-8 w-8 rounded-md bg-gray-200">{cardType.icon}</div>
