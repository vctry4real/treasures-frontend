      ...
      <div className="items-center">
        ...
        <div className="">
          <div className="">
            ...
            {isOtp ? (
              <div className="">
                <h2 className="font-serif mb-1 text-white text-3xl font-bold tracking-wide">
                  You have entered the correct OTP
                </h2>
              </div>
            ) : (
              <div>
                <h2 className="mb-5 font-serif text-gray-500">
                  Enter the 4 digit code we sent to your email to verify your
                  email address.
                </h2>
              </div>
            )}
            ...
            <div>
              <p>
                ...
                <span className="text-red-700">
                  <button onClick={'API call and reset timer'}>Resend</button>
                </span>
              </p>
            </div>
