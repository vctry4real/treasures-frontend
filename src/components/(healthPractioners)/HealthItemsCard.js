                ...
                <div className="">
                    <div className="">
                        ...
                        <div className="flex flex-col gap-2 p-3">
                            <p className='flex items-center'><span className='mr-2'><PiFirstAidKit /></span>{props.description}</p>
                            <h3 className='flex items-center'><span className='mr-2'><IoChatbubbleEllipsesOutline /></span>{props.history}</h3>
                        </div>
                        ...
                        <div className=" flex items-center bg-slate-100 p-3 ">
                            ...
                            <button className='ml-auto bg-primary py-1 px-3 text-center text-white rounded-lg'>Book</button>
                        </div>
                    </div>
                </div>
            </HealthCard>
